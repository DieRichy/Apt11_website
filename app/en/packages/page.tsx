...
export default function PackagesPage() {
  return <>
    ...
    <section className="section"><div className="shell"><div className="package-grid">{journeyPackages.map((item) => <PackageCard item={item} key={item.slug} />)}</div><p className="price-disclaimer">Airfare is not included. Hotel room category, restaurant reservations, vehicle class, service availability, taxes, and final terms are confirmed in your proposal.</p></div></section>
