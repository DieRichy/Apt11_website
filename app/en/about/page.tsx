...
export default function AboutPage() {
  return <>
    ...
    <section className="section"><div className="shell principle-grid about-principles">
      <article className="principle about-principle"><span className="number">01</span><span className="about-kanji" aria-hidden="true">誠</span><div className="about-principle-copy"><h3>Honest</h3><p className="muted">We distinguish confirmed facts from possibilities and keep terms clear.</p></div></article>
      <article className="principle about-principle"><span className="number">02</span><span className="about-kanji" aria-hidden="true">静</span><div className="about-principle-copy"><h3>Calm</h3><p className="muted">We reduce noise, pressure, and needless decisions.</p></div></article>
      <article className="principle about-principle"><span className="number">03</span><span className="about-kanji" aria-hidden="true">人</span><div className="about-principle-copy"><h3>Human-centered</h3><p className="muted">The journey begins with how you actually want to travel.</p></div></article>
    </div></section>
    <section className="section section-tint"><div className="shell split"><div><p className="eyebrow">Two useful channels</p><h2>Tailored planning here.<br />Standard stays there.</h2></div><div className="split-copy"><p>Use this website when you want to begin a conversation about a tailored FIT journey. For ordinary accommodation browsing and standard transactions, apt11.jp remains the main channel.</p><Link className="arrow-link" href="https://apt11.jp">Visit apt11.jp <OpenLinkIcon /></Link></div></div></section>
    <CTA />
  </>;
}
