...
export default function DestinationsPage() {
  return <>
    ...
    <section className="section"><div className="shell"><SectionHeading eyebrow="Osaka to the wider region" title="Six directions through Kansai and beyond." /><div className="destination-grid">{destinations.map((destination) => <DestinationCard destination={destination} key={destination.slug} />)}</div></div></section>
